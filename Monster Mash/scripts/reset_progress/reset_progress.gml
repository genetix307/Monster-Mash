...
store.retailrevenge_best_minute=0
store.retailrevenge_best_second=0
store.retailrevenge_best_level=0
store.retailrevenge_best_saved=0
store.grimgraves_best_minute=0
store.grimgraves_best_second=0
store.grimgraves_best_level=0
store.grimgraves_best_saved=0
store.fearfactory_best_minute=0
store.fearfactory_best_second=0
store.fearfactory_best_level=0
store.fearfactory_best_saved=0
store.hellishhills_best_minute=0
store.hellishhills_best_second=0
store.hellishhills_best_level=0
store.hellishhills_best_saved=0
store.terrortown_best_minute=0
store.terrortown_best_second=0
store.terrortown_best_level=0
store.terrortown_best_saved=0
//Settings
